...
const (
	...
	RegistryServer_NewMembers_FullMethodName = "/protos.RegistryServer/NewMembers"
	RegistryServer_DelMembers_FullMethodName = "/protos.RegistryServer/DelMembers"
)
...
func (c *registryServerClient) NewMembers(ctx context.Context, in *NewMembersRequest, opts ...grpc.CallOption) (*NewMembersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NewMembersResponse)
	err := c.cc.Invoke(ctx, RegistryServer_NewMembers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *registryServerClient) DelMembers(ctx context.Context, in *DelMembersRequest, opts ...grpc.CallOption) (*DelMembersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DelMembersResponse)
	err := c.cc.Invoke(ctx, RegistryServer_DelMembers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRegistryServerServer) NewMembers(context.Context, *NewMembersRequest) (*NewMembersResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method NewMembers not implemented")
}
func (UnimplementedRegistryServerServer) DelMembers(context.Context, *DelMembersRequest) (*DelMembersResponse, error) {
...
func _RegistryServer_NewMembers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NewMembersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RegistryServerServer).NewMembers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RegistryServer_NewMembers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RegistryServerServer).NewMembers(ctx, req.(*NewMembersRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _RegistryServer_DelMembers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DelMembersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RegistryServerServer).DelMembers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RegistryServer_DelMembers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RegistryServerServer).DelMembers(ctx, req.(*DelMembersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RegistryServer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RegistryServer_NewMembers_Handler,
		},
		{
			MethodName: "DelMembers",
			Handler:    _RegistryServer_DelMembers_Handler,
		},
	},
